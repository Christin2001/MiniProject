...
$cities = ["Kottayam","Changanasserry","Erattupetta","Kanjirapally","Manimala","Pala","Mundakayam","Ettumanoor","Kannur",
"Kozhikode","Kochi","Kollam","Alappuzha","Manjeri","Kasargod","Thrissur","Thalassery","Pathanamthitta"];
    ...
    <div class="row">
        ...
        <div class="form-group col-5">
            ...
            <select class="form-control" name="profession" id="profession">
                ...
                <option value="car">Carpenter</option>
                <option value="painter">Painter</option>
                <option value="cleaning">Cleaning</option>
                <option value="interior">Interior decorator</option>
                <option value="solar">Solar Energy Consultant</option>
                <option value="Sweeps">Chimney Sweeps</option>
